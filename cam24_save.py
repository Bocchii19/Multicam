...
LATENCY_MS = 100
USE_GPU = True
WINDOW_NAME = "🎥 16x H.265 (GPU nvv4l2decoder)"
SAVE_DIR = "saved_grids"  # Thư mục lưu ảnh
SAVE_INTERVAL = 1.0       # giây / ảnh
    ...
    try:
        while True:
            ...
            if now - last_save >= SAVE_INTERVAL:
                filename = os.path.join(SAVE_DIR, f"grid_{time.strftime('%Y%m%d_%H%M%S')}.jpg")
